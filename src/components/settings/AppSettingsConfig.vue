<template>
  <div
    class="h-full flex flex-col bg-[#1e1e1e] rounded-lg border border-gray-800 overflow-hidden shadow-sm"
  >
    <!-- Toolbar -->
    <div
      class="flex items-center justify-between p-2 border-b border-gray-800 bg-[#1a1a1a]"
    >
    ...
    <div
      class="px-3 py-1.5 bg-[#141414] border-t border-gray-800 text-[10px] text-gray-500 flex justify-between"
    >
