                ...
                <div v-for="ver in installed" :key="ver"
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center"
                            :class="ver === current ? 'bg-blue-900/40 text-blue-400' : 'bg-gray-800 text-gray-400'">
                        ...
                        <div class="flex flex-col">
                            <div class="flex items-center space-x-2">
                                ...
                                <span v-if="ver === current"
                                    class="px-2 py-0.5 bg-blue-600 text-white text-[10px] rounded uppercase font-bold tracking-wider shadow-sm">Global</span>
                            </div>
                        </div>
                    </div>

                    <div class="flex space-x-2 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                        <button v-if="ver !== current" @click="setGlobal(ver)" :disabled="loading"
