    ...
    <div class="flex-1 overflow-y-auto p-6 animate-fade-in">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <Card class="flex flex-col items-center justify-between min-h-[280px]">
                ...
                <CardContent class="flex flex-col items-center w-full">
                        ...
                        <div class="relative w-24 h-24 flex items-center justify-center">
                            <svg class="w-full h-full transform -rotate-90">
                                ...
                                <circle v-for="(disk, idx) in topDisks" :key="disk.mount" cx="48" cy="48"
                                    ...
                                    :stroke-dashoffset="getOffset(idx, disk.use)" stroke-linecap="round"
                    ...
                    <div class="flex-1 overflow-y-auto max-h-40 pr-2 custom-scrollbar space-y-2">
                        <div v-for="(disk, idx) in displayDisks" :key="disk.mount"
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-2.5 h-2.5 rounded-full" :style="{ backgroundColor: getDiskColor(idx) }">
                                </div>
